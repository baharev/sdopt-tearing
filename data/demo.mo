// Copyright (c) 2012-2015, University of Vienna
// All rights reserved.
// BSD license.
...
//==============================================================================
//
// The generated model equations are derived from those in:
// E.W. Jacobsen and S. Skogestad. Multiple steady states in ideal two-product 
// distillation. AIChE Journal, 37:499–511, 1991.
//
// The Modelica model is derived from the *rudimentary* prototype of the unit 
// operations coded in Modelica, the snapshot taken from the SVN repo 
// (rev. 1477, 02 May 2012). See also:
//
// Ali Baharev, Arnold Neumaier (2012). Chemical Process Modeling in Modelica, 
...
//==============================================================================
//
// There are quite a few hacks in the model: There is true degeneracy regarding
// the pressure, which leads to problems. Pressure-related things are simply
// commented out for now. The distillation column was made as short as possible,
// which also lead to some hacks. All in all, this model served to gain 
// experience and proved to be useful for testing purposes, but it should not be
// considered as an exemplary model.
...
//   end PressureChanger;
  ...
  partial class FlashBase
    extends SIDO;
    FlowRate L(min=0.1, max=10.0), V(min=0.1, max=10.0);
...
model JacobsenTest
    ...
    Condenser     condenser;
    VLEcascade    cascade(redeclare class Flash = IdealBinary, nStages=1, feedStage=1);
    Reboiler      reboiler;
    Sink          distillateSink;
    Sink          liquidSink;
